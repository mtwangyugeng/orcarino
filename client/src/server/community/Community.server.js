...
export function innerGetCommunityById(id) {
    const index = findInCsvArray(communityData, 'id', id);
    const c = communityData[index]
    const finale = {
            id: c[0],
            title: c[1],
